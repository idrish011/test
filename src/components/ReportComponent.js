...
class ReportComponent extends Component {
    ...
    onAddNew = (e) => {
        if (e == "TopRequestedAssets") {
            document.getElementById("Reports").src = "https://assethuboac-orasenatdpltinfomgmt03.analytics.ocp.oraclecloud.com/dv/ui/project.jsp?pageid=visualAnalyzer&reportmode=full&reportpath=%2F%40Catalog%2Fshared%2FAssethub-PROD%2FAssetsRequestedReport";
            ...
            document.getElementById("Reports").src = "https://assethuboac-orasenatdpltinfomgmt03.analytics.ocp.oraclecloud.com/dv/ui/project.jsp?pageid=visualAnalyzer&reportmode=full&reportpath=%2F%40Catalog%2Fshared%2FAssethub-PROD%2FVisitors%20Count%20Report";
            ...
            document.getElementById("Reports").src = "https://assethuboac-orasenatdpltinfomgmt03.analytics.ocp.oraclecloud.com/dv/ui/project.jsp?pageid=visualAnalyzer&reportmode=full&reportpath=%2F%40Catalog%2Fshared%2FAssethub-PROD%2FHeatMap%20-%20Prod";
            ...
            document.getElementById("Reports").src = "https://assethuboac-orasenatdpltinfomgmt03.analytics.ocp.oraclecloud.com/dv/ui/project.jsp?pageid=visualAnalyzer&reportmode=full&reportpath=%2F%40Catalog%2Fshared%2FAssethub-PROD%2FAssetViewsReport";
            ...
            <div className="App">
                ...
                <div class="pd20">
                    ...
                    <div class="mt40 report_panel">
                        <button id="VC" class="tab_btn btn-primary" onClick={(e) => this.onAddNew('VisitorsCount')}>Tool Visits</button>

                        <button id="VA" class="tab_btn btn-default" onClick={(e) => this.onAddNew('TopViewedAssets')}>Top Viewed Assets</button>
                        <button id="RA" class="tab_btn btn-default" onClick={(e) => this.onAddNew('TopRequestedAssets')}>Top Requested Assets</button>
                    ...
                    <p align="center">
                        ...
                        <iframe id="Reports"
                            ...
                            src="https://assethuboac-orasenatdpltinfomgmt03.analytics.ocp.oraclecloud.com/dv/ui/project.jsp?pageid=visualAnalyzer&reportmode=full&reportpath=%2F%40Catalog%2Fshared%2FAssethub-PROD%2FVisitors%20Count%20Report">
