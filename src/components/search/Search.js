...
export class Search extends Component {
  ...
  render() {
     if((global.selectedDropdownContract!="") ||(global.selectedDropdownContract!=null) || (global.selectedDropdownContract!=undefined)){
      var valueSearch=global.selectedDropdownContract;
     // document.getElementById('selectBox').value=valueSearch;
     // selectBox();
    ...
    return (
      <div className="ml-auto mr-auto search">
        ...
        }} placeholder="Search" className="" autoComplete="off" defaultValue={valueSearch} />  <Button variant="primary btn-lg" onClick={selectBox}><img src="../img/Icon_Search.png" /></Button>
        <a id="clrsrch" class= {((valueSearch != '')) ? ("ClearSearch clearall small pull-right"):(this.state.classClearSearch)} href="javascript:void(0)" onClick={() => {
          document.getElementById("selectBox").value = "";
          var ul = document.getElementById("myUL");
          ul.classList.add('hide');
          this.setState({
