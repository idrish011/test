  ...
  render() {
    ...
    return (
        ...
        <hr/>
            ...
            <div className="ml-5 text-center footerTitle">&copy;	Powered by &nbsp; &#10077; North America Cloud Engineering  &#10078;
            </div>


            <div class="LoderP" id="Loader">
              <div class="loadingContainer">
                <div>
                  <div class="commonLoader"></div>
            ...
            {((global.totalUniqueVisitors!="") && (global.totalUniqueVisitors!=undefined)&&(global.totalUniqueVisitors!=null))&& <div class="pull-right uniqueVisitors">Total  Visitors : <strong>{global.totalUniqueVisitors}</strong></div>}
        </div>
      </div>
    )
  }
