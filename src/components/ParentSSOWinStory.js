    ...
    //    alert(statusGov[1]);
        ...
        .then(res => {
          ...
          var likename;
            ...
            if(res.data.sharecount<1){
                var shareCount='Be first to share Win Story';
            }else{
      ...
      sendMail = (e) => {
        ...
        axios.post(global.Ip + global.Port + '/user/captureactivity/w/share/' + sessionStorage.getItem("user_name") + '/' + sessionStorage.getItem("user_email"),{},{ headers: {
            user_email: sessionStorage.getItem("user_email"),
            contentid:global.IDWinstory,
            contenttype:"winstory"          

        }})
        .then(response => {
            window.open('mailto:?subject=Win reference from AssetHub &body=Please explore the win '+window.location.href);
...
// console.log(likeNamesplit);
    ...
    this.setState({
        ...
        //window.open('mailto:@oracle.com?subject=Win reference from AssetHub &body=Please explore the win '+window.location.href);
